...
export const CAPABILITIES: Capability[] = [
  ...
  { id: "startFeatureBranch", group: "Dev", context: "action", description: "Start a git feature branch before BOS changes." },
  { id: "stageChanges", group: "Dev", context: "action", description: "Stage changed files." },
  { id: "gitStatus", group: "Dev", context: "action", description: "Show git branch and changes." },
  ...
  { id: "git_branch", group: "Dev", context: "tool", description: "Create a git branch (sub-agent)." },
  { id: "git_stage", group: "Dev", context: "tool", description: "Stage files (sub-agent)." },
  { id: "git_status", group: "Dev", context: "tool", description: "Git status (sub-agent)." },
