...
2. Call `app_build({ name, dir, icon })` again with the same item name/id — it overwrites the changed facet(s), re-bundles/re-activates as needed, and lands on the active feature branch for the user to preview and promote (see Step 2 above).
