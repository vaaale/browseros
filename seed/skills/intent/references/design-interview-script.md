...
Use this script to gather requirements for a feature with a UI. Ask the questions in order; confirm each answer before moving on. Record confirmed answers directly into the spec.
