...
- **Files:** [working with your files](usage/file-tools/working-with-your-files.md)
- **Memory:** [how memory works](usage/memory/how-memory-works.md)
- **Self‑improvement:** [learning from experience](usage/self-improvement/learning-from-experience.md) · [skills](usage/self-improvement/skills.md) · [self‑healing](usage/self-healing.md)
...
- **File tools:** [the agent's VFS surface](dev/file-tools/file-tools.md) — all eleven `file_*` tools, the branch‑coupling rules, and the recipe for adding one
- [Memory](dev/memory/memory.md) · [Self‑improvement](dev/self-improvement/self-improvement.md) · [Self‑healing](dev/self-healing/self-healing.md)
